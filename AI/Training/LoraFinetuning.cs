...
{
    public static class  LoraFinetuning
    {
        ...
        /// <summary>
        /// Builds ShareGPT dataset from packs. No LM-Kit trainer types required.
        /// </summary>
        ...
        /// <summary>
        /// Training is disabled until LM-Kit LoRA trainer type is confirmed in your package.
        /// </summary>
        public static void Train(TrainConfig? config = null)
        {
            ...
            throw new NotSupportedException(
                "This LM-Kit package does not expose LoraFinetuning. " +
                "Dataset export works. Next step: find the real LoRA type in Object Browser.");
        }
    }
}
